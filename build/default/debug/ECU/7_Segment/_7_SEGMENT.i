...
# 12 "ECU/7_Segment/_7_SEGMENT.h"
# 1 "ECU/7_Segment/../../MCAL/GPIO/GPIO.h" 1
# 12 "ECU/7_Segment/../../MCAL/GPIO/GPIO.h"
# 1 "ECU/7_Segment/../../MCAL/GPIO/../COMPILER.h" 1
# 14 "ECU/7_Segment/../../MCAL/GPIO/../COMPILER.h"
...
# 14 "ECU/7_Segment/../../MCAL/GPIO/../COMPILER.h" 2
# 12 "ECU/7_Segment/../../MCAL/GPIO/GPIO.h" 2

# 1 "ECU/7_Segment/../../MCAL/GPIO/../STD_TYPES.h" 1
# 13 "ECU/7_Segment/../../MCAL/GPIO/../STD_TYPES.h"
# 1 "ECU/7_Segment/../../MCAL/GPIO/../STD_LIBS.h" 1
# 11 "ECU/7_Segment/../../MCAL/GPIO/../STD_LIBS.h"
...
# 11 "ECU/7_Segment/../../MCAL/GPIO/../STD_LIBS.h" 2
...
# 13 "ECU/7_Segment/../../MCAL/GPIO/../STD_LIBS.h" 2
# 13 "ECU/7_Segment/../../MCAL/GPIO/../STD_TYPES.h" 2

# 1 "ECU/7_Segment/../../MCAL/GPIO/../DEVICE_CFG.h" 1
# 14 "ECU/7_Segment/../../MCAL/GPIO/../STD_TYPES.h" 2
# 43 "ECU/7_Segment/../../MCAL/GPIO/../STD_TYPES.h"
...
# 1 "ECU/7_Segment/../../MCAL/GPIO/GPIO_CFG.h" 1
# 16 "ECU/7_Segment/../../MCAL/GPIO/GPIO.h" 2
# 26 "ECU/7_Segment/../../MCAL/GPIO/GPIO.h"
typedef enum {
    GPIO_LOW = 0,
    GPIO_HIGH
} logic_t;
...
# 94 "ECU/7_Segment/../../MCAL/GPIO/GPIO.h"
...
# 12 "ECU/7_Segment/_7_SEGMENT.h" 2

# 1 "ECU/7_Segment/_7_SEGMENT_CFG.h" 1
# 13 "ECU/7_Segment/_7_SEGMENT.h" 2
# 29 "ECU/7_Segment/_7_SEGMENT.h"
typedef enum{
    SEG_COM_ANODE = 0,
    SEG_COM_CATHODE
} segment_type_t;
...
# 8 "ECU/7_Segment/_7_SEGMENT.c" 2
# 22 "ECU/7_Segment/_7_SEGMENT.c"
Std_ReturnType ECU_7_SEG_Init(const segment_t *seg){

    Std_ReturnType ret = (Std_ReturnType)0x00;

    if(((void*)0) != seg){
        ret = GPIO_PIN_Init(&(seg->segment_pins[0]));
        ret = GPIO_PIN_Init(&(seg->segment_pins[1]));
        ret = GPIO_PIN_Init(&(seg->segment_pins[2]));
        ret = GPIO_PIN_Init(&(seg->segment_pins[3]));
    }
    else{
...
# 54 "ECU/7_Segment/_7_SEGMENT.c"
Std_ReturnType ECU_7_SEG_Write_Number(const segment_t *seg, uint8 number){

    Std_ReturnType ret = (Std_ReturnType)0x00;

    if(((void*)0) != seg && number <= 9){
        ret = GPIO_PIN_Write(&(seg->segment_pins[0]), (number & 0x01));
        ret = GPIO_PIN_Write(&(seg->segment_pins[1]), ((number >>1) & 0x01));
        ret = GPIO_PIN_Write(&(seg->segment_pins[1]), ((number >>2) & 0x01));
        ret = GPIO_PIN_Write(&(seg->segment_pins[1]), ((number >>3) & 0x01));
    }
    else{
        ret = (Std_ReturnType)0x00;
    }
