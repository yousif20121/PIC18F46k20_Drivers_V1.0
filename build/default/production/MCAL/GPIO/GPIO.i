...
# 1 "MCAL/GPIO/../STD_LIBS.h" 1
# 11 "MCAL/GPIO/../STD_LIBS.h"
...
Std_ReturnType GPIO_PIN_Direction_Init(const pin_config_t *_pin_config){
    ...
    if(((void*)0) != _pin_config && _pin_config->port <= 5 - 1 && _pin_config->pin <= 8 - 1){
        switch(_pin_config->direction){
            case GPIO_OUTPUT:
                (*TRIS_REG[_pin_config->port] &= ~(1 << _pin_config->pin));
...
Std_ReturnType GPIO_PIN_Write(const pin_config_t *_pin_config, logic_t logic){
    ...
    if(((void*)0) != _pin_config && _pin_config->port <= 5 - 1 && _pin_config->pin <= 8 - 1){
        switch(logic){
            case GPIO_LOW:
                (*LAT_REG[_pin_config->port] &= ~(1 << _pin_config->pin));
                ret = (Std_ReturnType)0x01;
                break;
...
# 153 "MCAL/GPIO/GPIO.c"
Std_ReturnType GPIO_PIN_Get_Direction(const pin_config_t *_pin_config, direction_t *direction_status){

    Std_ReturnType ret = (Std_ReturnType)0x00;

    if(((void*)0) != _pin_config && ((void*)0) != direction_status && _pin_config->port <= 5 - 1 && _pin_config->pin <= 8 - 1){
        *direction_status = ((*TRIS_REG[_pin_config->port] >> _pin_config->pin) & 1);
        ret = (Std_ReturnType)0x01;
    }
    else{
        ret = (Std_ReturnType)0x00;
...
# 183 "MCAL/GPIO/GPIO.c"
Std_ReturnType GPIO_PIN_Read(const pin_config_t *_pin_config, logic_t *logic){

    Std_ReturnType ret = (Std_ReturnType)0x00;

    if(((void*)0) != _pin_config && ((void*)0) != logic && _pin_config->port <= 5 - 1 && _pin_config->pin <= 8 - 1){
        *logic = ((*PORT_REG[_pin_config->port] >> _pin_config->pin) & 1);
        ret = (Std_ReturnType)0x01;
    }
    else{
        ret = (Std_ReturnType)0x00;
