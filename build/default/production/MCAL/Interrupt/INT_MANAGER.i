# 1 "MCAL/Interrupt/INT_MANAGER.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL/Interrupt/INT_MANAGER.c" 2
...
# 1 "MCAL/Interrupt/INT_MANAGER.h" 1
# 12 "MCAL/Interrupt/INT_MANAGER.h"
# 1 "MCAL/Interrupt/INT_CONFIG.h" 1
# 12 "MCAL/Interrupt/INT_CONFIG.h"
# 1 "MCAL/Interrupt/../COMPILER.h" 1
# 14 "MCAL/Interrupt/../COMPILER.h"
...
# 14 "MCAL/Interrupt/../COMPILER.h" 2
# 12 "MCAL/Interrupt/INT_CONFIG.h" 2

# 1 "MCAL/Interrupt/../STD_TYPES.h" 1
# 13 "MCAL/Interrupt/../STD_TYPES.h"
# 1 "MCAL/Interrupt/../STD_LIBS.h" 1
# 11 "MCAL/Interrupt/../STD_LIBS.h"
...
# 11 "MCAL/Interrupt/../STD_LIBS.h" 2
...
# 13 "MCAL/Interrupt/../STD_LIBS.h" 2
# 13 "MCAL/Interrupt/../STD_TYPES.h" 2

# 1 "MCAL/Interrupt/../DEVICE_CFG.h" 1
# 14 "MCAL/Interrupt/../STD_TYPES.h" 2
# 43 "MCAL/Interrupt/../STD_TYPES.h"
...
# 13 "MCAL/Interrupt/INT_CONFIG.h" 2


# 1 "MCAL/Interrupt/../GPIO/GPIO.h" 1
# 16 "MCAL/Interrupt/../GPIO/GPIO.h"
# 1 "MCAL/Interrupt/../GPIO/GPIO_CFG.h" 1
# 16 "MCAL/Interrupt/../GPIO/GPIO.h" 2
# 26 "MCAL/Interrupt/../GPIO/GPIO.h"
typedef enum {
    GPIO_LOW = 0,
    GPIO_HIGH
} logic_t;
...
# 15 "MCAL/Interrupt/INT_CONFIG.h" 2

# 1 "MCAL/Interrupt/INT_GEN_CFG.h" 1
# 16 "MCAL/Interrupt/INT_CONFIG.h" 2
# 34 "MCAL/Interrupt/INT_CONFIG.h"
typedef enum{
    INTERRUPT_LP = 0,
    INTERRUPT_HP
} interrupt_priority_cfg;
# 12 "MCAL/Interrupt/INT_MANAGER.h" 2
# 21 "MCAL/Interrupt/INT_MANAGER.h"
void INT0_ISR(void);
void INT1_ISR(void);
void INT2_ISR(void);
...
# 8 "MCAL/Interrupt/INT_MANAGER.c" 2
...
# 62 "MCAL/Interrupt/INT_MANAGER.c"
void __attribute__((picinterrupt(("")))) InterruptManager(void){
    ...
    if((1 == INTCONbits.RBIE) && (1 == INTCONbits.RBIF) && (PORTBbits.RB4 == GPIO_HIGH) && (1 == RB4_Flag)) {
        RB4_Flag = 0;
        RB4_ISR(0);
    }
    else{ }
    if((1 == INTCONbits.RBIE) && (1 == INTCONbits.RBIF) && (PORTBbits.RB4 == GPIO_LOW) && (0 == RB4_Flag)) {
        RB4_Flag = 1;
        RB4_ISR(1);
    }
    else{ }
    ...
    if((1 == INTCONbits.RBIE) && (1 == INTCONbits.RBIF) && (PORTBbits.RB5 == GPIO_HIGH) && (1 == RB5_Flag)) {
        RB5_Flag = 0;
        RB5_ISR(0);
    }
    else{ }

    if((1 == INTCONbits.RBIE) && (1 == INTCONbits.RBIF) && (PORTBbits.RB5 == GPIO_LOW) && (0 == RB5_Flag)) {
        RB5_Flag = 1;
        RB5_ISR(1);
    }
    else{ }
    ...
    if((1 == INTCONbits.RBIE) && (1 == INTCONbits.RBIF) && (PORTBbits.RB6 == GPIO_HIGH) && (1 == RB6_Flag)) {
        RB6_Flag = 0;
        RB6_ISR(0);
    }
    else{ }

    if((1 == INTCONbits.RBIE) && (1 == INTCONbits.RBIF) && (PORTBbits.RB6 == GPIO_LOW) && (0 == RB6_Flag)) {
        RB6_Flag = 1;
        RB6_ISR(1);
    }
    else{ }
    ...
    if((1 == INTCONbits.RBIE) && (1 == INTCONbits.RBIF) && (PORTBbits.RB7 == GPIO_HIGH) && (1 == RB7_Flag)) {
        RB7_Flag = 0;
        RB7_ISR(0);
    }
    else{ }

    if((1 == INTCONbits.RBIE) && (1 == INTCONbits.RBIF) && (PORTBbits.RB7 == GPIO_LOW) && (0 == RB7_Flag)) {
        RB7_Flag = 1;
        RB7_ISR(1);
    }
    else{ }
