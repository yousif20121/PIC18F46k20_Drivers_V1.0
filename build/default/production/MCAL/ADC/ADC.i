...
# 14 "MCAL/ADC/../COMPILER.h" 2
# 12 "MCAL/ADC/ADC.h" 2

# 1 "MCAL/ADC/../STD_TYPES.h" 1
# 13 "MCAL/ADC/../STD_TYPES.h"
# 1 "MCAL/ADC/../STD_LIBS.h" 1
# 11 "MCAL/ADC/../STD_LIBS.h"
...
# 13 "MCAL/ADC/../STD_LIBS.h" 2
# 13 "MCAL/ADC/../STD_TYPES.h" 2

# 1 "MCAL/ADC/../DEVICE_CFG.h" 1
# 14 "MCAL/ADC/../STD_TYPES.h" 2
# 43 "MCAL/ADC/../STD_TYPES.h"
...
# 16 "MCAL/ADC/../GPIO/GPIO.h"
# 1 "MCAL/ADC/../GPIO/GPIO_CFG.h" 1
# 16 "MCAL/ADC/../GPIO/GPIO.h" 2
# 26 "MCAL/ADC/../GPIO/GPIO.h"
typedef enum {
    GPIO_LOW = 0,
    GPIO_HIGH
} logic_t;
...
# 1 "MCAL/ADC/../Interrupt/INT_CONFIG.h" 1
# 16 "MCAL/ADC/../Interrupt/INT_CONFIG.h"
# 1 "MCAL/ADC/../Interrupt/INT_GEN_CFG.h" 1
# 16 "MCAL/ADC/../Interrupt/INT_CONFIG.h" 2
# 34 "MCAL/ADC/../Interrupt/INT_CONFIG.h"
typedef enum{
    INTERRUPT_LP = 0,
    INTERRUPT_HP
...
# 1 "MCAL/ADC/../Interrupt/INT_INTERNAL.h" 1
# 16 "MCAL/ADC/ADC.h" 2

# 1 "MCAL/ADC/ADC_CFG.h" 1
# 17 "MCAL/ADC/ADC.h" 2
# 48 "MCAL/ADC/ADC.h"
typedef enum {
    ADC_CH_AN0 = 0,
...
static __attribute__((inline)) void config_voltage_ref(const adc_config_t *_adc);
...
static __attribute__((inline)) void adc_input_channel_port_config(adc_channel_select_t channel){
    switch(channel){
        case ADC_CH_AN0: (TRISA |= (1 << 0x0)); break;
        case ADC_CH_AN1: (TRISA |= (1 << 0x1)); break;
        case ADC_CH_AN2: (TRISA |= (1 << 0x2)); break;
        case ADC_CH_AN3: (TRISA |= (1 << 0x3)); break;
        case ADC_CH_AN4: (TRISA |= (1 << 0x5)); break;
        case ADC_CH_AN5: (TRISE |= (1 << 0x0)); break;
        case ADC_CH_AN6: (TRISE |= (1 << 0x1)); break;
        case ADC_CH_AN7: (TRISE |= (1 << 0x2)); break;
        case ADC_CH_AN8: (TRISB |= (1 << 0x2)); break;
        case ADC_CH_AN9: (TRISB |= (1 << 0x3)); break;
        case ADC_CH_AN10: (TRISB |= (1 << 0x1)); break;
        case ADC_CH_AN11: (TRISB |= (1 << 0x4)); break;
        case ADC_CH_AN12: (TRISB |= (1 << 0x0)); break;
    }
}
...
static __attribute__((inline)) void config_voltage_ref(const adc_config_t *_adc){
    if(0x01U == _adc->voltage_ref){
        do{ADCON1bits.VCFG1 = 1; ADCON1bits.VFG0 = 1; }while(0);
    }
    else if(0x00U == _adc->voltage_ref){
