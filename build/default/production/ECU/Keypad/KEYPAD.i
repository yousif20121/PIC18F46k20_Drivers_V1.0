...
# 12 "ECU/Keypad/../../MCAL/GPIO/GPIO.h"
# 1 "ECU/Keypad/../../MCAL/GPIO/../COMPILER.h" 1
# 14 "ECU/Keypad/../../MCAL/GPIO/../COMPILER.h"
...
# 14 "ECU/Keypad/../../MCAL/GPIO/../COMPILER.h" 2
# 12 "ECU/Keypad/../../MCAL/GPIO/GPIO.h" 2

# 1 "ECU/Keypad/../../MCAL/GPIO/../STD_TYPES.h" 1
# 13 "ECU/Keypad/../../MCAL/GPIO/../STD_TYPES.h"
# 1 "ECU/Keypad/../../MCAL/GPIO/../STD_LIBS.h" 1
# 11 "ECU/Keypad/../../MCAL/GPIO/../STD_LIBS.h"
...
# 11 "ECU/Keypad/../../MCAL/GPIO/../STD_LIBS.h" 2
...
# 13 "ECU/Keypad/../../MCAL/GPIO/../STD_LIBS.h" 2
# 13 "ECU/Keypad/../../MCAL/GPIO/../STD_TYPES.h" 2

# 1 "ECU/Keypad/../../MCAL/GPIO/../DEVICE_CFG.h" 1
# 14 "ECU/Keypad/../../MCAL/GPIO/../STD_TYPES.h" 2
# 43 "ECU/Keypad/../../MCAL/GPIO/../STD_TYPES.h"
...
# 1 "ECU/Keypad/../../MCAL/GPIO/GPIO_CFG.h" 1
# 16 "ECU/Keypad/../../MCAL/GPIO/GPIO.h" 2
# 26 "ECU/Keypad/../../MCAL/GPIO/GPIO.h"
typedef enum {
    GPIO_LOW = 0,
    GPIO_HIGH
} logic_t;
...
# 94 "ECU/Keypad/../../MCAL/GPIO/GPIO.h"
...
# 8 "ECU/Keypad/KEYPAD.c" 2



uint8 keypad_btn_values[4][4]={
                                                            {'7', '8', '9', '/'},
                                                            {'4', '5', '6', '*'},
                                                            {'1', '2', '3', '-'},
                                                            {'#', '0', '=', '+'}
                                                          };
# 30 "ECU/Keypad/KEYPAD.c"
Std_ReturnType ECU_KEYPAD_Init(const keypad_t *keypad){

    Std_ReturnType ret = (Std_ReturnType)0x00;

    uint8 rows_counter = 0x00;
    uint8 cols_counter = 0x00;

    if(((void*)0) != keypad){
        for(rows_counter = 0x00; rows_counter < 4; rows_counter++){
            ret = GPIO_PIN_Init(&(keypad->keypad_row_pins[rows_counter]));
        }
        for(cols_counter = 0x00; cols_counter < 4; cols_counter++){
...
# 68 "ECU/Keypad/KEYPAD.c"
Std_ReturnType ECU_KEYPAD_Get_Value(const keypad_t *keypad, uint8 *value){

    Std_ReturnType ret = (Std_ReturnType)0x00;

    uint8 g_rows_counter = 0x00;
    uint8 g_cols_counter = 0x00;

    uint8 g_counter = 0x00;

    uint8 col_logic = 0x00;

    if(((void*)0) != keypad && ((void*)0) != value){
        for(g_rows_counter = 0x00; g_rows_counter < 4; g_rows_counter++){
            for(g_counter = 0x00; g_counter < 4; g_counter++){
            ...
            for(g_cols_counter = 0x00; g_cols_counter < 4; g_cols_counter++){
