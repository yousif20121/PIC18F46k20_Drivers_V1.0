...
# 12 "ECU/DC_Motor/DC_MOTOR.h"
# 1 "ECU/DC_Motor/../../MCAL/GPIO/GPIO.h" 1
# 12 "ECU/DC_Motor/../../MCAL/GPIO/GPIO.h"
# 1 "ECU/DC_Motor/../../MCAL/GPIO/../COMPILER.h" 1
# 14 "ECU/DC_Motor/../../MCAL/GPIO/../COMPILER.h"
...
# 14 "ECU/DC_Motor/../../MCAL/GPIO/../COMPILER.h" 2
# 12 "ECU/DC_Motor/../../MCAL/GPIO/GPIO.h" 2

# 1 "ECU/DC_Motor/../../MCAL/GPIO/../STD_TYPES.h" 1
# 13 "ECU/DC_Motor/../../MCAL/GPIO/../STD_TYPES.h"
# 1 "ECU/DC_Motor/../../MCAL/GPIO/../STD_LIBS.h" 1
# 11 "ECU/DC_Motor/../../MCAL/GPIO/../STD_LIBS.h"
...
# 11 "ECU/DC_Motor/../../MCAL/GPIO/../STD_LIBS.h" 2
...
# 13 "ECU/DC_Motor/../../MCAL/GPIO/../STD_LIBS.h" 2
# 13 "ECU/DC_Motor/../../MCAL/GPIO/../STD_TYPES.h" 2

# 1 "ECU/DC_Motor/../../MCAL/GPIO/../DEVICE_CFG.h" 1
# 14 "ECU/DC_Motor/../../MCAL/GPIO/../STD_TYPES.h" 2
# 43 "ECU/DC_Motor/../../MCAL/GPIO/../STD_TYPES.h"
...
# 1 "ECU/DC_Motor/../../MCAL/GPIO/GPIO_CFG.h" 1
# 16 "ECU/DC_Motor/../../MCAL/GPIO/GPIO.h" 2
# 26 "ECU/DC_Motor/../../MCAL/GPIO/GPIO.h"
typedef enum {
    GPIO_LOW = 0,
    GPIO_HIGH
} logic_t;
...
# 94 "ECU/DC_Motor/../../MCAL/GPIO/GPIO.h"
...
# 12 "ECU/DC_Motor/DC_MOTOR.h" 2

# 1 "ECU/DC_Motor/DC_MOTOR_CFG.h" 1
# 13 "ECU/DC_Motor/DC_MOTOR.h" 2
# 30 "ECU/DC_Motor/DC_MOTOR.h"
typedef struct {
...
# 8 "ECU/DC_Motor/DC_MOTOR.c" 2
# 22 "ECU/DC_Motor/DC_MOTOR.c"
Std_ReturnType ECU_DC_MOTOR_Init(const dc_motor_t *dc_motor){
   ...
   if(((void*)0) != dc_motor){
       ...
       GPIO_PIN_Direction_Init(&(dc_motor->dc_motor[0x00U]));
       GPIO_PIN_Direction_Init(&(dc_motor->dc_motor[0x01U]));
...
Std_ReturnType ECU_DC_MOTOR_Forward(const dc_motor_t *dc_motor){
   ...
   if(((void*)0) != dc_motor){
       ...
       GPIO_PIN_Write(&(dc_motor->dc_motor[0x00U]), GPIO_HIGH);
       GPIO_PIN_Write(&(dc_motor->dc_motor[0x01U]), GPIO_HIGH);
...
Std_ReturnType ECU_DC_MOTOR_Stop(const dc_motor_t *dc_motor){
   ...
   if(((void*)0) != dc_motor){
       ...
       GPIO_PIN_Write(&(dc_motor->dc_motor[0x00U]), GPIO_LOW);
       GPIO_PIN_Write(&(dc_motor->dc_motor[0x01U]), GPIO_LOW);
